...
$res->prepare("select count(*) as 'total' from gruposgobierno"); $res->execute(); $res->bind_result($total);
...
if ($pag != 1) { echo " <a href='OP18.php?pag=" . ($pag - 1) . "'><</a> <a href='OP18.php?pag=1'>1</a> "; }
for ($i = $pag - 1; $i < $pag + 2; $i++) { if ($i > 1 && $i <= $numpag) { echo " <a href='OP18.php?pag=" . $i . "'>$i</a> "; } }
if ($pag != $numpag) { echo " ... <a href='OP18.php?pag=$numpag'>$numpag</a> <a href='OP18.php?pag=" . ($pag + 1) . "'>></a>"; }
