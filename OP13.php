...
<body>
    <?php require_once "../ModelosEstilos/OPM05.php"; $m = new OPM05(); $v = array();
...
if (isset($_POST["barcog"])) { $v = $m->getBarco(); } if (isset($_POST["b1"])) { $v = $m->getGruposCanon(); }
if (isset($_POST["b2"])) { $v = $m->getGruposNoCanon(); }
...
} echo "<form action='OP13.php' method='post'><select name='tipogv'>";
