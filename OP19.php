...
<head>
    <meta charset="UTF-8">
    <title>Bandas Piratas</title>
    <link rel="stylesheet" href="../ModelosEstilos/CSS2.css">
</head>

<body>
    <?php require_once "../ModelosEstilos/OPM07.php"; $m = new OPM07(); $v = array();
...
if (isset($_POST["barcog"])) { $v = $m->getBarco(); } if (isset($_POST["b1"])) { $v = $m->getGPiratasCanon(); }
if (isset($_POST["b2"])) { $v = $m->getGPiratasNoCanon(); }
...
} echo "<form action='OP19.php' method='post'><select name='tipogv'>";
